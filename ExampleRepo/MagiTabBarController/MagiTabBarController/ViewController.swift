...
class ViewController: UIViewController {
    ...
    public let titleArray = [
        [
            ...
            "MagiTabBarController like system style",
            "Mix MagiTabBar and UITabBar",
            "UITabBarController style with 'More'",
            "MagiTabBarController style with 'More'",
            "Mix MagiTabBar and UITabBar with 'More'",
            "UITabBarController style with non-zero default index",
            "MagiTabBarController style with non-zero default index"
        ],
        [
            "MagiTabBarController embeds the UINavigationController style",
            "UINavigationController embeds the MagiTabBarController style",
            ],
        [
    ...
    public let subtitleArray = [
        [
            ...
            "MagiTabBarController仿系统样式",
            "MagiTabBar和UITabBar混合样式",
            "带有'More'的UITabBarController样式",
            "带有'More'的MagiTabBarController样式",
            "带有'More'的MagiTabBar和UITabBar混合样式",
            "默认index非0的UITabBarController样式",
            "默认index非0的MagiTabBarController样式"
        ],
        [
