...
/*
 * MagiTabBarItemBadgeView
 * 这个类定义了item中使用的badge视图样式，默认为MagiTabBarItemBadgeView类对象。
 * 你可以设置MagiTabBarItemContentView的badgeView属性为自定义的MagiTabBarItemBadgeView子类，这样就可以轻松实现 自定义通知样式了。
 */
open class MagiTabBarItemBadgeView: UIView {
